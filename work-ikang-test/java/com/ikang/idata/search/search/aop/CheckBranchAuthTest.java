...
class CheckBranchAuthTest {

//    private CheckBranchAuth checkBranchAuthUnderTest;
//
//    @BeforeEach
//    void setUp() {
//        checkBranchAuthUnderTest = new CheckBranchAuth();
//    }
//
//    @Test
//    void testCheckUserAuth() {
//        // Setup
...
//
//        final JobDistrictHeadArea jobDistrictHeadArea1 = new JobDistrictHeadArea();
//        jobDistrictHeadArea1.setPostCode("postCode");
//        jobDistrictHeadArea1.setPostName("postName");
//        jobDistrictHeadArea1.setChiefZone(Arrays.asList("value"));
//
//        // Run the test
//        checkBranchAuthUnderTest.checkUserAuth(Arrays.asList(AuthType.MALL), allAuthData, jobDistrictHeadArea1);
//
//        // Verify the results
//    }
}

...
class AliveControllerTest {
    ...
    void testAlive() throws Exception {
        // Setup
        // Run the test
        final MockHttpServletResponse response = mockMvc.perform(get("/check/alive")
    ...
    @Test
    void testPostThresholdCheck() throws Exception {
        // Setup
        // Run the test
        final MockHttpServletResponse response = mockMvc.perform(post("/influx/check/threshold")

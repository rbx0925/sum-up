...
@WebMvcTest(SaleCheckinController.class)
class SaleCheckinControllerTest {
    ...
    void testFindAgg() throws Exception {
        ...
        // Run the test
        final MockHttpServletResponse response = mockMvc.perform(post("/saleWorkTableOperate/toCheck/findKanban")
    ...
    void testFindHistogram() throws Exception {
        ...
        // Run the test
        final MockHttpServletResponse response = mockMvc.perform(post("/saleWorkTableOperate/toCheck/findChart")
                        .content("content").contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON))
                .andReturn().getResponse();
    ...
    void testAnalysisOfIncomingData() throws Exception {
        ...
        final MockHttpServletResponse response = mockMvc.perform(
                        post("/saleWorkTableOperate/toCheck/analysisOfIncomingData")
                                .content("content").contentType(MediaType.APPLICATION_JSON)
                                .accept(MediaType.APPLICATION_JSON))
                .andReturn().getResponse();
    ...
    void testFind() throws Exception {
        ...
        // Run the test
        final MockHttpServletResponse response = mockMvc.perform(post("/saleWorkTableOperate/toCheck/findAggByItemNo")
                        .content("content").contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON))
                .andReturn().getResponse();

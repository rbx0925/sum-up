 ...
 * @date 2022/10/24
 */
public class GifCaptchaTest  extends AbstractCaptcha {
     ...
     * @param height 验证码高度
     */
    public GifCaptchaTest(int width, int height) {
        this(width, height, 5);
    }
     ...
     */
    public GifCaptchaTest(int width, int height, int codeCount) {
     ...
     * @return this
     */
    public GifCaptchaTest setQuality(int quality) {
        if (quality < 1) {
            quality = 1;
        }
     ...
     * @return this
     */
    public GifCaptchaTest setRepeat(int repeat) {
        if (repeat >= 0) {
            this.repeat = repeat;
        }
        return this;
     ...
     * @return this
     */
    public GifCaptchaTest setMaxColor(int maxColor) {
     ...
     * @return this
     */
    public GifCaptchaTest setMinColor(int minColor) {

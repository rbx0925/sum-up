...
import com.ikang.idata.search.search.entity.vo.CheckinAppletVO;
...
class CheckinAppletServiceTest {

    private CheckinAppletService checkinAppletServiceUnderTest;

    @BeforeEach
    void setUp() throws Exception {
        checkinAppletServiceUnderTest = new CheckinAppletService();
    }
    ...
    void testAssemblyConditions() throws Exception {
        ...
        // Run the test
        final BoolQueryBuilder result = checkinAppletServiceUnderTest.assemblyConditions(originalQueryConditions);
    ...
    void testFind() throws Exception {
        // Setup
        final CheckinAppletVO vo = new CheckinAppletVO();
        vo.setResourceId(0L);
        ...
        // Run the test
        final BaseSearch result = checkinAppletServiceUnderTest.find(vo);
    ...
    void testFindGroupBy() throws Exception {
        ...
        // Run the test
        final BaseSearch result = checkinAppletServiceUnderTest.findGroupBy(vo);

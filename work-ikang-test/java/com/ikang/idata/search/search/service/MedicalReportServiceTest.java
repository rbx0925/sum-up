...
class MedicalReportServiceTest {
    ...
    void setUp() throws Exception {
        medicalReportServiceUnderTest = new MedicalReportService();
    }
    ...
    void testAssemblyConditions() throws Exception {
        ...
        // Run the test
        final BoolQueryBuilder result = medicalReportServiceUnderTest.assemblyConditions(originalQueryConditions);
    ...
    void testFind() throws Exception {
        // Setup
        final MedicalReportVo vo = new MedicalReportVo();
        vo.setResourceId(0L);
        ...
        vo.setCheckLocid("checkLocid");

        // Run the test
        final BaseSearch result = medicalReportServiceUnderTest.find(vo);

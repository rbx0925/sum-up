...
//        IntStream.range(0, 100).boxed().forEachOrdered(System.out::print);
//        Person person1 = new Person();
//        person1.setName("name1");
//        person1.setSex("sex1");
//        Map<String, Object> map = null;
//        map = BeanUtil.beanToMap(person1);
//
//        //=============Bean转换成Map=======================//
...
//                }
    ...
    public BeanTest(int group, BigDecimal sale) {
        this.group = group;
        this.sale = sale;
    }
...
//    }
//
//    public static String getProperty1(Object bean, String name) throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {

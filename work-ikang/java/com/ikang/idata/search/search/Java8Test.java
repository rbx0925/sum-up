...
class Java8Test {
    ...
    @Test
    void testConverter() {
        assertThat(Java8.converter(0.0, 0.0, 0.0)).isEqualTo(0.0, within(0.0001));
    }
    ...
    void testCurriedConverter() {
        // Setup
        // Run the test
        final DoubleUnaryOperator result = Java8.curriedConverter(0.0, 0.0);

        // Verify the results
    }

    @Test
    void testExpandedCurriedConverter() {
        // Setup
        // Run the test
        final DoubleUnaryOperator result = Java8.expandedCurriedConverter(0.0, 0.0, 0.0);
    ...
    void testFrom() {
        // Setup
        // Run the test
        final Java8.LazyList<Integer> result = Java8.from(0);
    ...
    void testPrimes() {
        // Setup
        final Java8.MyList<Integer> numbers = null;

        // Run the test
        final Java8.MyList<Integer> result = Java8.primes(numbers);
    ...
    void testPrintAll() {
        // Setup
        final Java8.MyList<String> numbers = null;

        // Run the test
        Java8.printAll(numbers);
    ...
    @Test
    void testMyIf() {
        assertThat(Java8.MyIf(false, () -> "value", () -> "value")).isEqualTo("result");
    }

    @Test
    void testPatternMatchExpr() {
        // Setup
        final Java8.Expr e = new Java8.Expr();
        final Java8.TriFunction<String, Java8.Expr, Java8.Expr, String> binopcase = null;
        final Function<Integer, String> numcase = val -> {
            return "value";
        };

        // Run the test
        final String result = Java8.patternMatchExpr(e, binopcase, numcase, () -> "value");
    ...
    @Test
    void testGetLowCaloricDishesNamesInJava7() {
        // Setup
        final List<Java8.Dish> dishes = Arrays.asList(new Java8.Dish("name", false, 0, Java8.Dish.Type.MEAT));

        // Run the test
        final List<String> result = Java8.getLowCaloricDishesNamesInJava7(dishes);
    ...
    @Test
    void testGetLowCaloricDishesNamesInJava8() {
        // Setup
        final List<Java8.Dish> dishes = Arrays.asList(new Java8.Dish("name", false, 0, Java8.Dish.Type.MEAT));

        // Run the test
        final List<String> result = Java8.getLowCaloricDishesNamesInJava8(dishes);

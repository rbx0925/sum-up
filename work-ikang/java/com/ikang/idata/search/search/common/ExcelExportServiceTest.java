...
class ExcelExportServiceTest {
    ...
    void testExport1() throws Exception {
        ...
        when(mockBaseService.dataListGroup(Arrays.asList(new HashMap<>()), Arrays.asList(new HashMap<>())))
                .thenReturn(Arrays.asList(Arrays.asList("value")));
        when(mockBaseService.head(Arrays.asList(new HashMap<>()))).thenReturn(Arrays.asList(Arrays.asList("value")));
        when(mockBaseService.dataList(Arrays.asList(new HashMap<>()), Arrays.asList(new HashMap<>())))
                .thenReturn(Arrays.asList(Arrays.asList("value")));

        // Run the test
        excelExportServiceUnderTest.export(response, String.class, "param", "title");
    ...
    @Test
    void testFindExport() throws Exception {
        // Setup
        final HttpServletResponse response = new MockHttpServletResponse();
        when(mockBaseService.dataList(Arrays.asList(new HashMap<>()), Arrays.asList(new HashMap<>())))
                .thenReturn(Arrays.asList(Arrays.asList("value")));
        ...
        // Run the test
        excelExportServiceUnderTest.findExport(response, "service", "param", "title");

        // Verify the results
    }

    @Test
    void testFindExport_BaseServiceDataListReturnsNoItems() throws Exception {
        // Setup
        final HttpServletResponse response = new MockHttpServletResponse();
        when(mockBaseService.dataList(Arrays.asList(new HashMap<>()), Arrays.asList(new HashMap<>())))
                .thenReturn(Collections.emptyList());
    ...
    @Test
    void testFindExport_BaseServiceHeadReturnsNoItems() throws Exception {
        // Setup
        final HttpServletResponse response = new MockHttpServletResponse();
        when(mockBaseService.dataList(Arrays.asList(new HashMap<>()), Arrays.asList(new HashMap<>())))
                .thenReturn(Arrays.asList(Arrays.asList("value")));
    ...
    @Test
    void testFindExport_ThrowsIOException() {
        // Setup
        final HttpServletResponse response = new MockHttpServletResponse();
        when(mockBaseService.dataList(Arrays.asList(new HashMap<>()), Arrays.asList(new HashMap<>())))
                .thenReturn(Arrays.asList(Arrays.asList("value")));
    ...
    void testExport3_ThrowsIOException() {
        ...
        assertThatThrownBy(() -> excelExportServiceUnderTest.export(response, "service", "param", "title", "findMethod",
                "aggrMethod")).isInstanceOf(IOException.class);
    }

...
-- ----------------------------
INSERT INTO `cms_article` VALUES (1, 1, '测试文章', NULL, NULL, '立东', NULL, 10.00, 2, '0d18a2b016f3421685dc20c41306b61e', NULL, 1, NULL, '{}', NULL, NULL, '2022-04-05 20:30:38.955', '2022-04-05 22:37:55.567', 1);
...
CREATE TABLE `sys_config`  (
                               ...
                               `is_deleted` tinyint(1) UNSIGNED NULL DEFAULT 1 COMMENT '是否删除(1->未删除|NO,2->已删除|YES)',
                               PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '参数配置' ROW_FORMAT = Dynamic;

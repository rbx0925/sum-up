...
@WebMvcTest(AreaWorkCustomerSatisfactionController.class)
class AreaWorkCustomerSatisfactionControllerTest {
    ...
    void testFind() throws Exception {
        ...
        // Run the test
        final MockHttpServletResponse response = mockMvc.perform(post("/areaWorkPlatform/mainCustomerSatisfaction")

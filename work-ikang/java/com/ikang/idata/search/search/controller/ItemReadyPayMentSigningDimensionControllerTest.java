...
@WebMvcTest(ItemReadyPayMentSigningDimensionController.class)
class ItemReadyPayMentSigningDimensionControllerTest {
    ...
    void testFindItemReadyPaymentAgg() throws Exception {
        ...
        // Run the test
        final MockHttpServletResponse response = mockMvc.perform(post("/itemReadyPayMentSigningDimension/findAgg")
    ...
    void testFindItemReadyPayMent() throws Exception {
        ...
        // Run the test
        final MockHttpServletResponse response = mockMvc.perform(post("/itemReadyPayMentSigningDimension/find")
                .content("content").contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON))
                .andReturn().getResponse();
    ...
    void testDepartmentExportExcel() throws Exception {
        ...
        final MockHttpServletResponse response = mockMvc.perform(
                post("/itemReadyPayMentSigningDimension/itemReadyPayMentSign")
                        .content("content").contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON))
                .andReturn().getResponse();

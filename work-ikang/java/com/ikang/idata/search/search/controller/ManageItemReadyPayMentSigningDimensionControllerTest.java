...
@WebMvcTest(ManageItemReadyPayMentSigningDimensionController.class)
class ManageItemReadyPayMentSigningDimensionControllerTest {
    ...
    void testFindItemReadyPaymentAgg() throws Exception {
        ...
        // Run the test
        final MockHttpServletResponse response = mockMvc.perform(post("/ManageitemReadyPayMentSigningDimension/findAgg")
    ...
    void testFindItemReadyPayMent() throws Exception {
        ...
        // Run the test
        final MockHttpServletResponse response = mockMvc.perform(post("/ManageitemReadyPayMentSigningDimension/find")
                .content("content").contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON))
                .andReturn().getResponse();
    ...
    void testDepartmentExportExcel() throws Exception {
        ...
        final MockHttpServletResponse response = mockMvc.perform(
                post("/ManageitemReadyPayMentSigningDimension/itemReadyPayMentSign")
                        .content("content").contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON))
                .andReturn().getResponse();

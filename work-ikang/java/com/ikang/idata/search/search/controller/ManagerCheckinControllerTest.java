...
@WebMvcTest(ManagerCheckinController.class)
class ManagerCheckinControllerTest {
    ...
    void testFindAgg() throws Exception {
        ...
        // Run the test
        final MockHttpServletResponse response = mockMvc.perform(post("/managerWorkTableOperate/toCheck/findKanban")
    ...
    void testFindHistogram() throws Exception {
        ...
        // Run the test
        final MockHttpServletResponse response = mockMvc.perform(post("/managerWorkTableOperate/toCheck/findChart")
                .content("content").contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON))
                .andReturn().getResponse();
    ...
    void testAnalysisOfIncomingData() throws Exception {
        ...
        final MockHttpServletResponse response = mockMvc.perform(
                post("/managerWorkTableOperate/toCheck/analysisOfIncomingData")
                        .content("content").contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON))
                .andReturn().getResponse();
    ...
    void testFind() throws Exception {
        ...
        // Run the test
        final MockHttpServletResponse response = mockMvc.perform(
                post("/managerWorkTableOperate/toCheck/findAggByItemNo")
                        .content("content").contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON))
                .andReturn().getResponse();

 ...
 * @date 2023/3/1 9:30
 */
public class ExportParamTest extends ExcelBaseParams {
    ...
    public ExportParamTest() {

    }

    public ExportParamTest(String title, String sheetName) {
        this.title = title;
        this.sheetName = sheetName;
    }

    public ExportParamTest(String title, String sheetName, ExcelType type) {
        this.title = title;
        this.sheetName = sheetName;
        this.type = type;
    }

    public ExportParamTest(String title, String secondTitle, String sheetName) {
        this.title = title;
    ...
    public String toString() {
        return "ExportParamTest{" +
                "title='" + title + '\'' +
                ", titleHeight=" + titleHeight +
                ", secondTitle='" + secondTitle + '\'' +
                ", secondTitleHeight=" + secondTitleHeight +
                ", sheetName='" + sheetName + '\'' +
                ...
                ", isCreateHeadRows=" + isCreateHeadRows +
                ", isDynamicData=" + isDynamicData +
                ", isAppendGraph=" + isAppendGraph +

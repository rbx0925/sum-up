 ...
 * @date 2022/9/21
 */
public class ExistsQueryBuilderTest extends AbstractQueryBuilder<ExistsQueryBuilder> {
    ...
    public ExistsQueryBuilderTest(String fieldName) {
     ...
     * Read from a stream.
     */
    public ExistsQueryBuilderTest(StreamInput in) throws IOException {
        super(in);

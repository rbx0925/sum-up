 ...
 * @date 2022/10/27
 */
public class GifCaptchaTest1  extends AbstractCaptcha {
     ...
     * @param height 验证码高度
     */
    public GifCaptchaTest1(int width, int height) {
        this(width, height, 5);
    }
     ...
     */
    public GifCaptchaTest1(int width, int height, int codeCount) {
     ...
     * @return this
     */
    public GifCaptchaTest1 setQuality(int quality) {
        if (quality < 1) {
            quality = 1;
        }
     ...
     * @return this
     */
    public GifCaptchaTest1 setRepeat(int repeat) {
        if (repeat >= 0) {
            this.repeat = repeat;
        }
        return this;
     ...
     * @return this
     */
    public GifCaptchaTest1 setMaxColor(int maxColor) {
     ...
     * @return this
     */
    public GifCaptchaTest1 setMinColor(int minColor) {

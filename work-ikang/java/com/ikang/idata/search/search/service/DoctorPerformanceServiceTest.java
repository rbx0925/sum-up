...
class DoctorPerformanceServiceTest {

    private DoctorPerformanceService doctorPerformanceServiceUnderTest;

    @BeforeEach
    void setUp() throws Exception {
        doctorPerformanceServiceUnderTest = new DoctorPerformanceService();
    }

    @Test
    void testFind() throws Exception {
        // Setup
        final DoctorPerformanceVo vo = new DoctorPerformanceVo();
        vo.setResourceId(0L);
        vo.setPageSize(0);
        ...
        // Run the test
        final BaseSearch result = doctorPerformanceServiceUnderTest.find(vo);
    ...
    void testAssemblyConditions() throws Exception {
        ...
        // Run the test
        final BoolQueryBuilder result = doctorPerformanceServiceUnderTest.assemblyConditions(originalQueryConditions);

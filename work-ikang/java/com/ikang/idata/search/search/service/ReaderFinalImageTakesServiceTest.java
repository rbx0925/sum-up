...
class ReaderFinalImageTakesServiceTest {

    private ReaderFinalImageTakesService readerFinalImageTakesServiceUnderTest;

    @BeforeEach
    void setUp() throws Exception {
        readerFinalImageTakesServiceUnderTest = new ReaderFinalImageTakesService();
    }
    ...
    void testAssemblyConditions() throws Exception {
        ...
        // Run the test
        final BoolQueryBuilder result = readerFinalImageTakesServiceUnderTest.assemblyConditions(
    ...
    void testFind() throws Exception {
        // Setup
        final ReaderFinalImageTakesVO vo = new ReaderFinalImageTakesVO();
        vo.setResourceId(0L);
        ...
        vo.setLocationNameName("locationNameName");

        // Run the test
        final BaseSearch result = readerFinalImageTakesServiceUnderTest.find(vo);
    ...
    void testFindGroupBy() throws Exception {
        ...
        // Run the test
        final BaseSearch result = readerFinalImageTakesServiceUnderTest.findGroupBy(vo);

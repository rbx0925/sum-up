...
class ReportInterpretationServiceTest {
    ...
    private ReportInterpretationService reportInterpretationServiceUnderTest;

    @BeforeEach
    void setUp() throws Exception {
        reportInterpretationServiceUnderTest = new ReportInterpretationService();
    }
    ...
    void testAssemblyConditions() throws Exception {
        ...
        // Run the test
        final BoolQueryBuilder result = reportInterpretationServiceUnderTest.assemblyConditions(
    ...
    void testFind() throws Exception {
        ...
        // Run the test
        final BaseSearch result = reportInterpretationServiceUnderTest.find(searchVO);
    ...
    void testFindGroupBy() throws Exception {
        ...
        // Run the test
        final BaseSearch result = reportInterpretationServiceUnderTest.findGroupBy(searchVO);

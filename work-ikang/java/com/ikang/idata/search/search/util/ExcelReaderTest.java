...
public class ExcelReaderTest {
     ...
     */
    @Deprecated
    public ExcelReaderTest(InputStream in, ExcelTypeEnum excelTypeEnum, Object customContent,
     ...
     */
    @Deprecated
    public ExcelReaderTest(InputStream in, Object customContent, AnalysisEventListener eventListener) {
     ...
     */
    @Deprecated
    public ExcelReaderTest(AnalysisParam param, AnalysisEventListener eventListener) {
     ...
     */
    @Deprecated
    public ExcelReaderTest(InputStream in, Object customContent, AnalysisEventListener eventListener, boolean trim) {
    ...
    public ExcelReaderTest(ReadWorkbook readWorkbook) {
        excelAnalyser = new ExcelAnalyserImpl(readWorkbook);
    }
     ...
     *            Read sheet
     */
    public ExcelReaderTest read(ReadSheet... readSheet) {
     ...
     * @return
     */
    public ExcelReaderTest read(List<ReadSheet> readSheetList) {

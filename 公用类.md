...
@Configuration
@MapperScan("com.ikang.bprom.mapper")
...
[springBoot跨域支持](./spring/SpringBoot处理跨域的五种方案.md)
...
```java
import com.ikang.bprom.service.utils.HttpClient;
...
public class RestTemplateConfig {
    ...
    public RestTemplate OKHttp3RestTemplate(){
        ...
        factory.setConnectTimeout(60000); // 单位毫秒, 设置60秒
        factory.setReadTimeout(60000);
        factory.setWriteTimeout(60000);
        return new RestTemplate(factory);
    }


    @Bean(HttpClient.OK_HTTP_3_REST_TEMPLATE)
    public RestTemplate okhttp3Rest(){
    ...
    @Bean(HttpClient.OK_HTTP_3_REST_TEMPLATE_SCRIPT_AGG)
   ...
   /* @Bean("restTemplate2")
    public RestTemplate OKHttp3RestTemplate2(){
        OkHttp3ClientHttpRequestFactory factory = new OkHttp3ClientHttpRequestFactory();
        factory.setConnectTimeout(60000); // 单位毫秒, 设置60秒
        factory.setReadTimeout(60000);
        factory.setWriteTimeout(60000);
...
import com.ikang.bprom.common.constant.MagicConst;
...
public class SwaggerConfig {
    private static final String BASE_PACKAGE = "com.ikang.bprom.api.controller";
    @Value("${SWAGGER_SWITCH}")
    private Boolean enableSwagger;

    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("B端促到检平台文档").build();
    }
    ...
    public Docket createDocket() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select().apis(enableSwagger ? RequestHandlerSelectors.basePackage(BASE_PACKAGE) : RequestHandlerSelectors.none()).build().apiInfo(apiInfo())
     ...
     * @date 2019-05-23 上午 10:21
     */
    public List<Parameter> setHeaderToken() {
        ParameterBuilder tokenPar = new ParameterBuilder();
        List<Parameter> pars = new ArrayList<>();
        tokenPar.name(MagicConst.TOKEN_HEADER)
                .description("token")
                .modelRef(new ModelRef("string"))
                .parameterType("header")
                .defaultValue(MagicConst.TEST_TOKEN)
                .required(false)
                .build();
...
[springBoot全局格式化](./spring/Springboot 全局时间格式化方式)
...
public class DateConfig {
    ...
    private static final DateTimeFormatter FORMATTER1 = DateTimeFormatter.ofPattern(DatePattern.NORM_DATETIME_MINUTE_PATTERN);
    private static final DateTimeFormatter FORMATTER2 = DateTimeFormatter.ofPattern(DatePattern.NORM_DATE_PATTERN);
    ...
    public static class LocalDateDeserializer implements ObjectDeserializer {
        ...
        public <T> T deserialze(DefaultJSONParser parser, Type type, Object fieldName) {
            ...
            if (value.contains(STRIKETHROUGH)) {
                int length = value.length();
                switch (length) {
                    case 10:
                        if (type.equals(LocalDateTime.class)) {
                            return (T) LocalDateTime.parse(value, FORMATTER2);
                        } else {
                            return (T) LocalDate.parse(value, FORMATTER2);
                        }
                    case 16:
                        if (type.equals(LocalDateTime.class)) {
                            return (T) LocalDateTime.parse(value, FORMATTER1);
                        } else {
                            return (T) LocalDate.parse(value, FORMATTER1);
                        }
                    default:
                        if (type.equals(LocalDateTime.class)) {
...
public class DecimalFormatUtil {
    ...
    public static String formatPercent(Object num){
        ...
        return PERCENT_SIGN_FORMAT.format(bigDecimal);
    }
    ...
    public static void main(String[] args) {
        ...
        AreaWorkTableCheckVO checkVO = new AreaWorkTableCheckVO();
        checkVO.setCheckIncome(BigDecimal.valueOf(10000.222));
        System.out.println(checkVO.getCheckIncome());
    }
}
```
...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        String projectPath = "D:\\ShangGuiGu\\sph\\gmall-parent\\gmall-service";
        // 设置父模块名称
        ...
        // 设置数据库连接
        String databaseUrl = "jdbc:mysql://123.249.100.189:3306/gmall_" + moduleName + "?useUnicode=true&useSSL=false&characterEncoding=utf8";
        // 数据库用户名
        String username = "root";
        //TODO 数据库密码
        String password = "Rbx508780..";
...
//		gc.setFileOverride(true);
        ...
        // 3、数据源配置
        DataSourceConfig dsc = new DataSourceConfig();
        dsc.setUrl("jdbc:mysql://172.172.172.249:3306/ikang_bprom?characterEncoding=utf8&useSSL=true");
        dsc.setDriverName("com.mysql.jdbc.Driver");
        dsc.setUsername("ikang_bprom");
        dsc.setPassword("ikang_bprom");
        dsc.setDbType(DbType.MYSQL);
        mpg.setDataSource(dsc);

        // 4、包配置
        PackageConfig pc = new PackageConfig();
        pc.setParent("com.ikang.bprom");
        Map<String, String> pathinfo =new HashMap<>();
        pathinfo.put(ConstVal.ENTITY_PATH, projectPath + "/src/main/java/com/ikang/bprom/entity");
        pathinfo.put(ConstVal.MAPPER_PATH, projectPath + "/src/main/java/com/ikang/bprom/mapper");
        pathinfo.put(ConstVal.SERVICE_PATH, projectPath + "/src/main/java/com/ikang/bprom/service");
        pathinfo.put(ConstVal.SERVICE_IMPL_PATH, projectPath + "/src/main/java/com/ikang/bprom/service/impl");
        pathinfo.put(ConstVal.CONTROLLER_PATH, projectPath + "/src/main/java/com/ikang/bprom/controller");
...
//		TemplateConfig templateConfig = new TemplateConfig();
////        使用controller自定义模板
//		templateConfig.setController("/templates/generator/controller");
//		templateConfig.setXml("/templates/generator/mapper");
//		mpg.setTemplate(templateConfig);
